...
ids=$(docker images | tail -n +2 | ag -v '^(?:rabbitmq|python|redis|postgres|adminer|minio|confluentinc|maven|busybox|localstack|jenkins|openjdk|ubuntu|oraclelinux|container-registry.oracle.com|fat|.+[.]amazonaws[.]com|cowpox)[ /]' | awk '{ print $3 }')
